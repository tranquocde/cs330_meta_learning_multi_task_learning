"""Implementation of prototypical (non-parametric, means that doesn't have meta-params) networks for Omniglot."""
...
class ProtoNet:
    ...
    def _step(self, task_batch):
        ...
        for task in task_batch:
            ...
            # print('shape: ',labels_support.shape)
            # ********************************************************
            # ******************* YOUR CODE HERE *********************
            # ********************************************************
            ...
            # Intuition: the distance for the correct label should be small, means that y_q is close to c_ts
